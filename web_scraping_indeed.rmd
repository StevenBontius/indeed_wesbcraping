...
## Soft skills
analytisch
communicatief / communicatieve
inzichten
presenteren
klantgerichtheid / klantcontact
...
```{r}
# functions to check for key words present in data
...
# loading data 
full_job_data <- read.csv("full_job_listing_flat.csv")
```
