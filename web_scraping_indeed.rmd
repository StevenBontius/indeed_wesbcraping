...
for(i in 1:nrow(test)) {
    Sys.sleep(2)
    job_page_url <- glue("https://nl.indeed.com/vacature-bekijken?jk={test[i,1]}")
    ...
    # extracting the company url for more information about the company
    company_url <- web_page %>%
        html_node(".icl-u-lg-mr--sm") %>% 
        html_attr("href")
